...
export default function Navbar(props) {
  ...
  return (
    <>
      <motion.div
        className="fixed bottom-0 right-0 w-full z-10 flex flex-col items-center md:justify-center h-max md:top-1/2 md:right-10 md:w-16 md:h-min mt-auto md:mt-0"
